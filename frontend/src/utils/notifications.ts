...
export class NotificationManager {
  ...
  public static showToast(message: string, type: 'success' | 'danger' | 'warning' | 'info' = 'info', title?: string): void {
    ...
    if (element && (window as any).bootstrap) {
      const toast = new (window as any).bootstrap.Toast(element, { delay: 4500 });
      toast.show();
  ...
  public static success(message: string, title: string = 'Success'): void {
    this.showToast(message, 'success', title);
  }

  public static error(message: string, title: string = 'Error'): void {
    this.showToast(message, 'danger', title);
  }

  public static warning(message: string, title: string = 'Warning'): void {
    this.showToast(message, 'warning', title);
  }

  public static info(message: string, title: string = 'Information'): void {
